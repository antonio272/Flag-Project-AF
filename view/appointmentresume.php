...
<html lang="en">
    ...
    <head>
        ...
        <title>Appointment resume</title>
        <!-- BOOTSTRAP CSS -->
    ...
    <body>
        ...
        <?php
                foreach( $_SESSION["appointment"] as $infoappointment) {
        ?>
                                <tr>
                                    <th><?php echo $infoappointment["specialty_name"]; ?></th>
                                    <th><?php echo $infoappointment["doctor_name"]; ?></th>
                                    <th><?php echo $infoappointment["datehour"]; ?></th>
                                </tr>
        ...
        ?>
                            ...
                            <p>Please confirm your appointment,<a href="<?=BASE_PATH?>confirmation"></i>Conclude here</a>.</p>
