...
?>
                            ...
                            <form method="post" action="<?=BASE_PATH?>access/login"> <!-- login.php -->
                                <div>
                                    <label>
                                        <input type="email" name="email" placeholder="Insert your email" id="" required autofocus>
                                    </label>
                                </div>
                                <div>
                                    <label>
                                        <input type="password" name="password" placeholder="Insert your password" id="" minlength="8" maxlength="1000" required>
                                    </label>
                                </div>
                                <div>
